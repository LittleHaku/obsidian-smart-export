...
- **Regular expression redaction rules**: optional regular expression rules, one per line, for removing patterned content such as emails, URLs, footnotes, comments, or private YAML lines.
