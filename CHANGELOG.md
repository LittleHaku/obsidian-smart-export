...
- `Markdown template folder` suggestions are now cached and reused while typing, with vault-change invalidation to avoid rebuilding/sorting on every keystroke
